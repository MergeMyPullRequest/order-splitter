...
Polymer({
        ...
        configure: function(config) {
            ...
            this._effect = new KeyframeEffect(node, [
                    {offset: 0,   transform: 'perspective(1000px) rotateY(180deg)'},
                    // {offset: 0.5, transform: 'perspective(1000px) rotateY(-90deg)'},
                    {offset: 1,   transform: 'perspective(1000px) rotateY(0deg)'},
...
Polymer({
        ...
        configure: function(config) {
            ...
            this._effect = new KeyframeEffect(node, [
                    {offset: 0,   transform: 'perspective(1000px) rotateY(0deg)'},
                    // {offset: 0.5, transform: 'perspective(1000px) rotateY(-90deg)'},
                    {offset: 1,   transform: 'perspective(1000px) rotateY(-180deg)'},
            ], this.timingFromConfig(config));
...
// this is to help with debugging any SW caching issues if they appear
            console.debug('script version: ae50f0e');